...
ctrHref = trimTrailingSlash('http://www.freevisitorcounters.com'.trim()); ctrHref2 = trimTrailingSlash('http://www.freevisitorcounters.com'.trim()); eInDoc = function (e) {
    ...
    if (linkfound == false) {
        var div = document.createElement('div'); div.id = 'error_6dc48f83683bbb2d2dc9d37d95844729c9aa3408'; div.innerHTML = ''; if (document.getElementById('counterimg') != null) { document.getElementById('counterimg').parentNode.insertBefore(div, document.getElementById('counterimg').nextSibling); } else { document.body.appendChild(div); }
