...
if (page == '1') {
    ...
    createItem("1v1.lol", "1v1.LOL", "https://agentsgams.github.io/gams/xml/1v1lol.html", "./thumbs/1v1lol.png", "white", "is a battle royale type game where you must survive with bots as enemeies. There are many different gamemodes- as well.", true)
    // total here: 50
}
...
if (page == '2') {
    ...
    createItem("bigshotboxing", "Big Shot Boxing", "https://agentsgams.github.io/gams/xml/bigshotboxing.html", "./thumbs/bigshotboxing.png", "white", "is a fighting sim where you must be the top in boxing.", true)
    createItem("sr3d2", "Snow Rider 3D 2", "https://agentsgams.github.io/gams/xml/snowrider3d2.html", "./thumbs/snowrider3d.png", "white", "is a infinite runner, but you are on a sliegh! Very challenging, can you get all the presents?")
    createItem("s2p", "SLOPE 2 Players", "https://agentsgams.github.io/gams/xml/slope2player.html", "./thumbs/slope-2-player-logo.jpg", "white", "is a infinite runner by SLOPE, but its for 2 players isntead of 1.", true)
    createItem("soccerlegends", "Soccer Legends", "https://agentsgams.github.io/gams/xml/soccerlegends.html", "./thumbs/footballlegends.png", "white", "is another type of Basketball Legends, but soccer!", true)
    createItem("hellokittyadventure", "Hello Kitty Adventure", "https://agentsgams.github.io/gams/xml/hellokittyadventure.html", "./thumbs/hellokittyadventure.png", "white", "allows you to inbark in a new adventure in the Hello Kitty universe.", true)
    ...
    createItem("polytrack", "Polytrack", "https://agentsgams.github.io/gams/xml/polytrack.html", "./thumbs/polytrack.png", "white", "is a racing game, runs well on basically anything, and is super fun! (Even your own custom editor..)", true)
    ...
    createItem("pixelspeedrun", "Pixel Speedrun", "https://agentsgams.github.io/gams/xml/pixelspeedrun.html", "./thumbs/pixelspeedrun.jpg", "white", "makes you get to the end of the tough platform. Try beating your time!", true)
    ...
    createItem("javelinfighting", "Javelin Fighting", "https://agentsgams.github.io/gams/xml/javelinfighting.html", "./thumbs/javelinfighting.jpg", "white", "makes you fight an AI opponent in a fatal javelin fight!", true)
    ...
    createItem("timeshooter2", "Time Shooter 2", "https://agentsgams.github.io/gams/xml/timeshooter2.html", "./thumbs/timeshooter2.png", "white", "the second of the Time Shooter saga.", true)
    createItem("sportsheadsHockey", "Sport Heads: Ice Hockey", "https://agentsgams.github.io/gams/xml/1on1hockey.html", "./thumbs/1on1hockey.png", "white", "is a game where you fight AI in a tough, customizated battle of hockey!", false)
    createItem("fnaf", "Five Nights at Freddys", "https://agentsgams.github.io/gams/xml/fnaf.html", "./thumbs/fivenightsatfreddys.png", "white", "is the 2015 classic ported to Flash!", true)
    createItem("douchebagworkout2", "Douchebag Workout 2", "https://agentsgams.github.io/gams/xml/douchebagworkout2.html", "./thumbs/douchebagworkout2.png", "white", "makes you go on an adventure being the fittest person in the world- scratch that- the *douchebagest* person.", true)
    createItem("unicyclehero", "Unicycle Hero", "https://agentsgams.github.io/gams/xml/unicyclehero.html", "./thumbs/unicylcehero.avif", "white", "-- can you beat the competition in the strange genres?", true)
    createItem("garfieldscaryscavengerhunt", "Garfields Scary Scavenger Hunt", "https://agentsgams.github.io/gams/xml/garfieldscaryhunt.html", "./thumbs/garfieldscaryscavengerhunt.png", "white", "can you help Garfield and friends get through this scary, haunted mansion?", false)
    createItem("dunkshot", "Dunk Shot", "https://agentsgams.github.io/gams/xml/dunkshot.html", "./thumbs/dunkshot.png", "white", "get to as far up in the tower-- hooping.", true)
    ...
    createItem("learntofly", "Learn to Fly", "https://agentsgams.github.io/gams/flash/learntofly.html", "./thumbs/learntofly.JPG", "white", "is a classic flash gam where you teach a penguin to fly!", false)
    createItem("learntofly2", "Learn to Fly 2", "https://agentsgams.github.io/gams/flash/learntofly2.html", "./thumbs/learntofly2.JPG", "white", "is a classic flash gam where you teach a penguin to fly-- again!", false)
    createItem("minecrafttowerdefense", "Minecraft Tower Defense", "https://agentsgams.github.io/gams/flash/minecrafttowerdefense.html", "./thumbs/minecrafttowerdefense.png", "white", "is the unofficial flash game where you protect Steve from Minecraft monsters you remember!", false)
    ...
    createItem("picosschool", "Picos School", "https://agentsgams.github.io/gams/flash/picoschool.html", "./thumbs/picosSchool.png", "red", "is where you help Pico escape his school. Problem- this game is quite offensive. Very.", false)
    createItem("riddleschool", "Riddle School", "https://agentsgams.github.io/gams/flash/riddleschool.html", "./thumbs/riddleschool.jpeg", "white", "can you help Phil escape his school through puzzles?", false)
