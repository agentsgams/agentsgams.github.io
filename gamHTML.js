...
createItem("1v1.lol", "1v1.LOL", "https://agentn86.github.io/agentgam/gams/xml/1v1lol.xml", "./thumbs/1v1lol.png", "white", "is a battle royale type game where you must survive with bots as enemeies. There are many different gamemodes- as well.", true)
...
createItem("bigshotboxing", "Big Shot Boxing", "https://agentn86.github.io/agentgam/gams/xml/bigshotboxing.html", "./thumbs/bigshotboxing.png", "white", "is a fighting sim where you must be the top in boxing.", true)
createItem("sr3d2", "Snow Rider 3D 2", "https://agentn86.github.io/agentgam/gams/xml/snowrider3d2.html", "./thumbs/snowrider3d.png", "white", "is a infinite runner, but you are on a sliegh! Very challenging, can you get all the presents?", true)
...
createItem("hellokittyadventure", "Hello Kitty Adventure", "---------------", "./thumbs/hellokittyadventure.png", "white", "allows you to inbark in a new adventure in the Hello Kitty universe.", true)
...
createItem("polytrack", "Polytrack", "https://agentn86.github.io/agentgam/gams/xml/polytrack.html", "./thumbs/polytrack.png", "white", "is a racing game, runs well on basically anything, and is super fun! (Even your own custom editor..)", true)
...
createItem("pixelspeedrun", "Pixel Speedrun", "https://agentn86.github.io/agentgam/gams/xml/pixelspeedrun.html", "./thumbs/pixelspeedrun.jpg", "white", "makes you get to the end of the tough platform. Try beating your time!", true)
...
createItem("1on1hockey", "1 on 1 Hockey", "---------------------------", "./thumbs/1on1hockey.png", "white", "is a game where you fight AI in a tough, customizated battle of hockey!", true)
